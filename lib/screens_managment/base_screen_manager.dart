...
import 'order_history_manager.dart'; // صفحه جدید

class BaseScreenManager extends StatefulWidget {
  const BaseScreenManager({super.key});

  @override
  State<BaseScreenManager> createState() => _BaseScreenManagerState();
}

class _BaseScreenManagerState extends State<BaseScreenManager> {
          ...
          child: BottomNavigationBar(
            ...
            items: const [
              ...
              BottomNavigationBarItem(
                icon: Padding(
                  padding: EdgeInsets.only(bottom: 5),
                  child: Icon(FontAwesomeIcons.list, size: 22),
                ),
                activeIcon: Padding(
                  padding: EdgeInsets.only(bottom: 5),
                  child: Icon(FontAwesomeIcons.list, size: 22),
